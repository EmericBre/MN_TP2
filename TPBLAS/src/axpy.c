...
void mnblas_zaxpy(const int N, const void *alpha, const void *X, const int incX, void *Y, const int incY)
{
    ...
    for (i = 0, j = 0; ((i < N) && (j < N)); i += incX, j += incY)
    {
        ...
        ((complexe_double_t *)Y)[j].real = ((complexe_double_t *)alpha)->real * ((complexe_double_t *)X)[i].real - ((complexe_double_t *)alpha)->imaginary * ((complexe_double_t *)X)[i].imaginary + ((complexe_double_t *)Y)[i].real;
        ((complexe_double_t *)Y)[j].imaginary = ((complexe_double_t *)alpha)->real * ((complexe_double_t *)X)[i].imaginary + ((complexe_double_t *)alpha)->imaginary * ((complexe_double_t *)X)[i].real +((complexe_double_t *)Y)[i].imaginary; 
    }
